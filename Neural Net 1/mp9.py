...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='CS440/ECE448 MP9: Neural Nets and PyTorch')

    parser.add_argument('--dataset', dest='dataset_file', type=str, default = './data/mp9_data',
